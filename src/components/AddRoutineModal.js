...
import { addGroup, addRoutine, getUserGroups, updateWeekdaySchedule, } from '@/lib/firebase';
...
export function AddRoutineModal({ isOpen, onClose, onRoutineCreated, }) {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: _jsxs(DialogContent, { className: "bg-white dark:bg-gray-800 max-w-md mx-auto", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { className: "text-lg font-semibold text-gray-900 dark:text-white", children: t('routines.newTitle') }), _jsx(DialogDescription, { className: "text-gray-500 dark:text-gray-400", children: t('routines.newDescription') })] }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("div", { className: "space-y-4 py-2", children: [_jsxs("div", { className: "mb-4", children: [_jsx(Label, { htmlFor: "routine-name", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t('routines.name') }), _jsx(Input, { id: "routine-name", value: name, onChange: (e) => setName(e.target.value), placeholder: t('routines.namePlaceholder'), required: true })] }), _jsxs("div", { className: "mb-4", children: [_jsx(Label, { htmlFor: "routine-time", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Expected Time (Optional)" }), _jsx(Input, { id: "routine-time", type: "time", value: expectedTime, onChange: (e) => setExpectedTime(e.target.value), placeholder: t('routines.expectedTimePlaceholder') })] }), _jsxs("div", { className: "mb-4", children: [_jsx(Label, { htmlFor: "routine-group", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t('routines.groupLabel') }), _jsxs(Select, { onValueChange: handleGroupChange, children: [_jsx(SelectTrigger, { id: "routine-group", children: _jsx(SelectValue, { placeholder: t('routines.selectGroup') }) }), _jsxs(SelectContent, { children: [groups.map((group) => (_jsx(SelectItem, { value: group.id.toString(), children: group.name }, group.id))), _jsx(SelectItem, { value: "new", children: t('routines.createNewGroup') })] })] }), showNewGroupInput && (_jsx("div", { className: "mt-2", children: _jsx(Input, { value: newGroupName, onChange: (e) => setNewGroupName(e.target.value), placeholder: t('routines.newGroupNamePlaceholder'), className: "mt-1", required: showNewGroupInput }) }))] }), _jsxs("div", { className: "mb-4", children: [_jsx(Label, { htmlFor: "routine-priority", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t('routines.priorityLabel') }), _jsxs(Select, { defaultValue: priority, onValueChange: (val) => setPriority(val), children: [_jsx(SelectTrigger, { id: "routine-priority", children: _jsx(SelectValue, { placeholder: t('routines.selectPriority') }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "high", children: t('routines.high') }), _jsx(SelectItem, { value: "medium", children: t('routines.medium') }), _jsx(SelectItem, { value: "low", children: t('routines.low') })] })] })] }), _jsxs("div", { className: "mb-4", children: [_jsx(Label, { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t('routines.repeatLabel') }), _jsxs("div", { className: "grid grid-cols-7 gap-1", children: [_jsx(Toggle, { variant: selectedDays.monday ? 'selected' : 'day', pressed: selectedDays.monday, onPressedChange: () => toggleDay('monday'), className: `text-xs font-medium text-center ${selectedDays.monday
                                                        ...
                                                        ? 'bg-blue-500 text-white dark:bg-blue-600'
                                                        : 'bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600'}`, children: "D" })] })] })] }), _jsxs(DialogFooter, { className: "flex justify-end space-x-3 mt-6", children: [_jsx(Button, { type: "button", variant: "outline", onClick: onClose, disabled: isSubmitting, children: t('common.cancel') }), _jsx(Button, { type: "submit", disabled: isSubmitting, children: isSubmitting ? t('common.loading') : t('common.save') })] })] })] }) }));
}
