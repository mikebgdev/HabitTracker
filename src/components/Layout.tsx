    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors">
            ...
            <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href="/account"
                              className="ml-4 flex items-center border border-gray-300 dark:border-gray-600 px-3 py-1 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <div className="flex flex-1">
                ...
                <aside
                    className="hidden md:block w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4">
