...
export default function MyRoutines() {
    ...
    return (_jsxs(Layout, { children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h2", { className: "text-2xl font-bold", children: t('routines.title') }), _jsxs(Button, { onClick: () => setIsAddRoutineModalOpen(true), children: [_jsx(Plus, { className: "mr-2 h-4 w-4" }), " ", t('routines.add')] })] }), isLoading ? (_jsx("p", { className: "text-center", children: t('routines.loading') })) : routines.length > 0 ? (_jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-4", children: routines.map((routine) => (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: routine.name }) }), _jsx(CardContent, { children: _jsx(WeekdayScheduleDisplay, { routineId: routine.id }) }), _jsxs("div", { className: "flex justify-end gap-2 p-4", children: [_jsxs(Button, { variant: "outline", onClick: () => {
                                        setRoutineToEdit(routine);
                                        setIsEditRoutineModalOpen(true);
                                    }, children: [_jsx(Edit, { className: "mr-1 h-4 w-4" }), " ", t('routines.edit')] }), _jsxs(Button, { variant: "destructive", onClick: () => confirmDeleteRoutine(routine), children: [_jsx(Trash, { className: "mr-1 h-4 w-4" }), " ", t('routines.delete')] })] })] }, routine.id))) })) : (_jsx("p", { className: "text-center", children: t('routines.noRoutines') })), _jsx(AddRoutineModal, { isOpen: isAddRoutineModalOpen, onClose: () => setIsAddRoutineModalOpen(false), onRoutineCreated: async () => {
